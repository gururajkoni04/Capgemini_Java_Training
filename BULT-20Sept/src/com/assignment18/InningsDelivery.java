...
public class InningsDelivery {
	...
	public static void main(String args[]) {
		...
		long deliveryNumber = scan.nextLong();
		System.out.println(deliveryBO.findInningsNumber(inningsList, deliveryNumber));
	}
...
class Delivery {
	...
	public Delivery(Long aDeliveryNumber, String aBatsman, String aBowler, Long aRuns, Long aInningsNumber,
			Innings aInnings) {
...
class DeliveryBO {
	 ...
	 * String class and and construct a innings object.
	 */
	...
	public Delivery createDelivery(String data, Innings[] inningsList) {
		...
		System.out.println("Delivery can't be created!!!");
		return null;
	}
	...
	public String findInningsNumber(Innings[] inningsList, long deliveryNumber) {
		...
		Long dN = new Long(deliveryNumber);
		for (Innings inning : inningsList) {

			if (inning.getInningsNumber().equals(dN)) {
